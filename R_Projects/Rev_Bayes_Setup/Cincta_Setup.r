...
#trend_partition <- "Driven_Trend";				# name of character partition set that separate out characters suspected of showing driven trends (i.e., biased change).

# The output RevBayes scripts will look to this folder for data
read_data_directory <- "~/Documents/RevStudio_Projects/data/";
# The output RevBayes scripts will direct rearranged data to this folde
write_data_directory <- "~/Documents/RevStudio_Projects/data/";
# The output RevBayes scripts look to this folder for scripts
...
# this is the directory from which you are running this R-program
...
fbd_parameterization_script <- "Cincta_Range_Based_FBD_Parameterization.Rev";
fossil_interval_file <- "cincta_fossil_intervals_FA.tsv";
scribio_RevBayes_scripts_from_nexus_file_and_existing_FBD_script_and_data(analysis_name,fbd_parameterization_script,fossil_interval_file,taxon_subset_file,rate_partition,trend_partition,read_data_directory,write_data_directory,write_scripts_directory,local_directory,set_wdir);