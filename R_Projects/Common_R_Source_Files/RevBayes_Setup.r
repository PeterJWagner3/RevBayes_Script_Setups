...
if (control_taxon!="")	{
	...
	write.csv(evanesco_na_from_matrix(control_data$control_collections,""),
			  file=paste(local_directory,control_taxon,"_Collections.csv",sep=""),
			  row.names = F);
	write.csv(evanesco_na_from_matrix(control_data$control_occurrences,""),
			  file=paste(local_directory,control_taxon,"_Finds.csv",sep=""),
			  row.names = F);
	} else	{
